...
public class EndlessRunnerCharacter2D : MonoBehaviour 
{
	...
	public void Move(float move, bool crouch, bool jump)
	{
		...
		if (((m_Grounded && m_Anim.GetBool("Ground")) || !m_HasDoubledJumped) && jump)
		{
